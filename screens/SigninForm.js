...
export default class SignOutForm extends Component {
  ...
  changeActiveRadioInductionVideo(index) {
    ...
    this.setState({ radioInductionVideo: this.state.radioInductionVideo }, () => {
      this.setState({ inductedBefore: this.state.radioInductionVideo[index].label });
    });
  ...
  changeActiveRadioGlasshouse(index) {
    ...
    this.setState({ radioGlasshouses: this.state.radioGlasshouses }, () => {
      this.setState({ visitedGlasshouse: this.state.radioGlasshouses[index].label });
    });
  }
  ...
  submitData = () => {
    ...
    console.log("PERSON VISITING : " + this.state.personVisiting + " OR " + this.state.personVisitingText);
    ...
    if (visitorName) {
      if (companyName) {
        if (personVisiting) {
          if (inductedBefore) {
            if (visitedGlasshouse) {
              if (tcSelected) {
                ...
                db.addVisitor(allData).then((result) => {
                  ...
                  fetch(url, { mode: 'no-cors' }).then((response) => {
                    ...
                    if (response.status === 200) {
                      ...
                      Toast.showWithGravity('Sign In Completed.', Toast.LONG, Toast.CENTER);
              ...
              alert('Please select appropriate options if you have visited any glasshouses before ')
            ...
            alert('Please select appropriate options if you have not been inducted before ')
          ...
          alert('Please select name of the person you would like to meet on site ')
        ...
        <View style={styles.container}>
          ...
          <ScrollView style={styles.formContainer}
            ...
            <View style={styles.backgroundColor}>
              ...
              <Text style={styles.headerText}>1.  Name (if group, seperate by comma)</Text>
              ...
              <View style={styles.borderEdit}>
                <TextInput style={styles.textInputStyle}
                  ...
                  onChangeText={(text) => this.updateTextInput(text, 'visitorName')}
                  returnKeyType={"next"}
                  ref={(input) => { this.visitorName = input; }}
            ...
            <View style={styles.backgroundColor}>
              ...
              <View style={styles.borderEdit}>
                <TextInput style={styles.textInputStyle}
                  ...
                  autoCorrect={false}
                  enablesReturnKeyAutomatically={true}
                  onChangeText={(text) => this.updateTextInput(text, 'companyName')}
                  returnKeyType={"done"}
            ...
            >
              ...
              <View style={styles.backgroundColorImages}>
                ...
                <Text style={styles.headerText}>3.  Person Visiting: If unsure, select Herman Fourie</Text>
                ...
                <DropDownPicker
                  items={[
                    ...
                    { label: 'Paul Haxby', value: 'Paul Haxby' },
                  ...
                  style={{
                    backgroundColor: '#ffffff', marginRight: 20, borderColor: '#A9A9A9',
                    borderWidth: 1, marginLeft: 12
                  }}
                  itemStyle={{
                ...
                {(this.state.personVisiting === 'Others' || this.state.personVisiting === null) ?
                  <View style={styles.borderEditSmall}>
                    <TextInput style={styles.textInputStyle}
                      ...
                      autoCorrect={false}
                      enablesReturnKeyAutomatically={true}
                      onChangeText={(text) => this.updateTextInput(text, 'personVisitingText')}
                      returnKeyType={"next"}
            ...
            <View style={styles.backgroundColor}>
              ...
              <Text style={styles.headerText}>4.  Have you been inducted on site before?</Text>
              ...
              <View style={styles.flexDirection}>

                {
                  ...
                  (
                    <RadioButton key={key} button={item} onClick={this.changeActiveRadioInductionVideo.bind(this, key)} />
                  ))
                }
            ...
            <View style={styles.backgroundColorImages}>
              ...
              <Text style={styles.headerText}>5.  Have you visited any other glasshouses recently?</Text>
              ...
              <View style={styles.flexDirection}>

                {
                  ...
                  (
                    <RadioButton key={key} button={item} onClick={this.changeActiveRadioGlasshouse.bind(this, key)} />
                  ))
                }
              ...
              <Text style={styles.textStyle}>NOTE:  Full body suit, safety gumboots, foot covers and gloves are required {"\n"}(Please see pictures below).</Text>
            ...
            <View style={styles.backgroundColorImages}>
              ...
              <Text style={styles.headerText}>Health {'&'} Safety requirements for the site. {"\n\n"}While onsite at T{'&'}G GER site please observe the following:</Text>

              <View style={styles.spaceInBetweenDropdown} />

              <Text style={styles.textStyleCheckboxed}>1. Follow all site signage and all reasonable instructions of Management team.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>2. Forklifts {'&'} Trucks have right of way over all other traffic on site, including cars {'&'} pedestrians.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>3. Vehicles must park in designated areas and observe traffic flows, including speed limits {'&'} Reverse parking.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>4. All injury's, near misses, {'&'} hazards must be reported. Please inform the Management team in such an occurrence.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>5. In an emergency the alarm will sound. On hearing the alarm, proceed immediately to the evacuation area.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>6. Entry into the glasshouse is at Management discretion {'&'} requires the wearing of boots, shoe covers, a coat, {'&'} the use of all foot-baths.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>7. Bees are present within the glasshouses, notify Management before entering if you are allergic.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>8. Notify Management as soon as possible if you require any assistance due to health reasons.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>9. No smoking except in designated areas at all times.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>10. No food or drink (except water or if you are diabetic) allowed in the glasshouses. No chewing gum allowed on site.</Text>

              <View style={styles.spaceInBetween} />

              <Text style={styles.textStyleCheckboxed}>11. Remember to sign out before leaving site.</Text>
